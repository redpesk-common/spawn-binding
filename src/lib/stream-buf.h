...
extern
void
stream_buf_clear(stream_buf_t *sbuf);

// realloc and reset the stream buffer
extern
stream_buf_t *
stream_buf_init(stream_buf_t *sbuf, size_t capacity);

// realloc and reset the stream buffer
extern
stream_buf_t *
stream_buf_resize(stream_buf_t *sbuf, size_t capacity);

// ensure at least the size of available data in the stream buffer
extern
stream_buf_t *
stream_buf_ensure(stream_buf_t *sbuf, size_t size);

// realloc and reset the stream buffer
extern
stream_buf_t *
stream_buf_create(size_t capacity);

// free memory used by the new stream buffer and the stream buffer itself
extern
void
stream_buf_free(stream_buf_t *sbuf);
...
extern
int
stream_buf_read_fd(stream_buf_t *sbuf, int fd);

// removes the bytes at the beginning of the stream buffer
extern
void
stream_buf_consume(stream_buf_t *sbuf, size_t size);

static inline
size_t
stream_buf_length(stream_buf_t *sbuf)
{
	return sbuf->length;
}
...
static inline
char *
stream_buf_data(stream_buf_t *sbuf)
{
	return sbuf->data;
}
...
static inline
size_t
stream_buf_capacity(stream_buf_t *sbuf)
{
...
static inline
bool
stream_buf_is_full(stream_buf_t *sbuf)
{
